...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('pelanggan.delete') }}" method="post">@csrf
            <div class="modal-content">
                <div class="modal-header">
                    <li class="bx bx-trash"></li>&nbsp;
                    <h6 class="modal-title" id="myExtraLargeModalLabel">Konfirmasi Hapus</h6>
                ...
                <div class="modal-footer">
                    <div class="btn-group">
                        ...
                        <button type="submit" class="btn btn-sm btn-danger">
                            <li class="bx bx-trash me-1 align-middle"></li> Hapus
                        </button>
                    </div>
                </div>
            </div>
