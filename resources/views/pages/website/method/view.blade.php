            ...
            <div class="card-header pt-2 pb-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <span class="card-title" style="font-size: 15px;"> Payment Methods</span>
                    </div>
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a href="{{ route('website-method.edit', ['id'=> $v->id]) }}" class="dropdown-item edit-item-btn">
    ...
    <div class="col-lg-4" id="card-none1">
        <div class="card">
            <div class="card-header pt-2 pb-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <span class="card-title" style="font-size: 15px;"> Form Payment Methods</span>
                    </div>
                    <div class="flex-shrink-0">
                    </div>
                </div>
            ...
            <div class="card-body collapse show" id="collapseexample1">
                <form method="post" action="{{ isset($one) ? route('website-method.update', ['id' => $one->id]) : route('website-method.store') }}" enctype="multipart/form-data">@csrf
                    <fieldset>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <center>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="{{ route('website-method') }}">
...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('website-method.delete') }}" method="post">@csrf
