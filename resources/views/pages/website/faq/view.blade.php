            ...
            <div class="card-header pt-2 pb-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <span class="card-title" style="font-size: 15px;"> Frequently Ask Question</span>
                    </div>
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a href="{{ route('website-faq.edit', ['id'=> $v->id]) }}" class="dropdown-item edit-item-btn">
    ...
    <div class="col-lg-4" id="card-none1">
        <div class="card">
            <div class="card-header pt-2 pb-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <span class="card-title" style="font-size: 15px;"> Form Frequently Ask Question</span>
                    </div>
                    <div class="flex-shrink-0">
                    </div>
                </div>
            ...
            <div class="card-body collapse show" id="collapseexample1">
                <form method="post" action="{{ isset($one) ? route('website-faq.update', ['id' => $one->id]) : route('website-faq.store') }}" enctype="multipart/form-data">@csrf
                    <fieldset>
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="topic" class="form-label mb-0">Topic</label>
                                <input name="topic" type="text" class="form-control" value="{{ $one->topic ?? old('topic') }}">
                                <label for="question" class="form-label mb-0">Question</label>
                                <input name="question" type="text" class="form-control" value="{{ $one->question ?? old('question') }}">
                                <label for="answer" class="form-label mb-0">Answer</label>
                                <textarea rows="4" name="answer" class="form-control">{{ $one->answer ?? old('answer') }}</textarea>
                            </div>
                        </div>
                        <hr class="mb-10">
                        <div class="row">
                            <div class="col-lg-12">
                                <center>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="{{ route('website-faq') }}">
...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('website-faq.delete') }}" method="post">@csrf
