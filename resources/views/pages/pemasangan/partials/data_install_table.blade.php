        ...
        <tbody>
            @forelse($data as $k => $v)
                <tr>
                    ...
                    <td>
                        <span class="badge 
                                @if($v->status == 'SELESAI') bg-success 
                                @elseif($v->status == 'SEDANG_DIPROSES') bg-info 
                    ...
                    <td>
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a href="{{ route('pemasangan.detail', $v->id) }}" class="dropdown-item">
        ...
        <div class="card mb-3 border">
            <div class="card-body p-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('pemasangan.detail', $v->id) }}" class="btn btn-soft-info btn-sm flex-grow-1">
