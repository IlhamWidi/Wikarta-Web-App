            ...
            <div class="card-header pt-2 pb-2">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <span class="card-title" style="font-size: 15px;"> Data Category</span>
                    </div>
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a href="{{ route('category.edit', ['id'=> $v->id]) }}" class="dropdown-item edit-item-btn">
    ...
    <div class="col-lg-4" id="card-none1">
        <div class="card">
            ...
            <div class="card-body collapse show" id="collapseexample1">
                <form method="post" action="{{ isset($one) ? route('category.update', ['id' => $one->id]) : route('category.store') }}">@csrf
                    <fieldset>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <center>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="{{ route('category') }}">
...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('category.delete') }}" method="post">@csrf
